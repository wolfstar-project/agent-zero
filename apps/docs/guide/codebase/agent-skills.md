...
`aube run check:repo` (backed by [`scripts/check-repository.mjs`](https://github.com/wolfstar-project/agent-zero/blob/main/scripts/check-repository.mjs)) enforces the skill conventions in CI:
...
[AGENTS.md](https://github.com/wolfstar-project/agent-zero/blob/main/AGENTS.md) and [.github/copilot-instructions.md](https://github.com/wolfstar-project/agent-zero/blob/main/.github/copilot-instructions.md) provide concise entry points for coding agents without replacing the human contributor guide. The pull-request rule in AGENTS.md applies to skills too: update documentation, examples, and skills in the same change that alters commands, boundaries, or contributor workflows.
