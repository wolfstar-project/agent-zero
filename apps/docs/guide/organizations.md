...
- The dashboard's organization UI lives in `apps/dashboard/modules/organizations/` — pages for creating an organization, managing members, and accepting invitations.
