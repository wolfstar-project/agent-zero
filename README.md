...
The dashboard needs to know where the adapter lives and which methods to offer:
`NUXT_PUBLIC_SITE_URL` (default `http://localhost:3001`),
`NUXT_PUBLIC_AUTH_ENABLE_SIGNUP`, and `NUXT_PUBLIC_AUTH_ENABLE_GITHUB_OAUTH`.
